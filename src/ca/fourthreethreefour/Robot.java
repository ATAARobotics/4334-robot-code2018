...
public class Robot extends IterativeRobotAdapter {
	...
	public void init() {
		...
		controller2.addWhenPressed(XboxController.LEFT_BUMPER, new SolenoidLeft(clawSolenoid));
		controller2.addWhenPressed(XboxController.RIGHT_BUMPER, new SolenoidRight(clawSolenoid));

		// TODO Set to right direction, make this a toggle
		// When the B button is pressed, it extends the armSolenoid
		// When the A button is pressed, it retracts the armSolenoid
		controller2.addWhenPressed(XboxController.B, new SolenoidLeft(flexSolenoid));
		controller2.addWhenPressed(XboxController.A, new SolenoidRight(flexSolenoid));
